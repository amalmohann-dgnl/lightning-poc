...
var APP_com_diagnal_app_lightningpoc = (function () {
    ...
    _createClass(TopNav, [{
      ...
      */
      function _init() {
        ...
        this.tag('Navbar.NavMenu').children = menus;
      ...
      value: function _states() {
        return [/*#__PURE__*/function (_this2) {
          _inherits(NavItems, _this2);
          var _super2 = _createSuper(NavItems);
          function NavItems() {
          ...
          _createClass(NavItems, [{
            ...
            key: "_getFocused",
            value: function _getFocused() {
              return this.tag('Navbar.NavMenu').children[this.index];
            }
          }]);
          return NavItems;
        }(this)];
  ...
  // App component
  var App = /*#__PURE__*/function (_ref) {
    _inherits(App, _ref);
